...
export const PAGES: DocPage[] = [
  ...
  "results": [
	...
	},
	{
		...
		summary: "Mêmes paramètres que GET /pois/search mais retourne uniquement name, type et coords. Conçu pour les rendus cartographiques où le poids de la réponse importe.",
		params: [
  ...
  "results": [
	...
	},
	{
		...
		summary: "Génère un itinéraire optimisé sur N jours. Fournissez soit une liste de POIs déjà sélectionnés (pois), soit une zone à explorer (poi_query) que le service délègue à GET /pois/search. Note : ce service est exposé sur un sous-domaine distinct (api.ai.* en production).",
		params: [
			...
			{ name: 'poi_query',      type: 'PoiQuery',    required: false, desc: 'Requête forwardée à GET /pois/search si pois est absent. Champs : mode, lat, lng, radius (≤50 000), polygon, district, types, lang, limit (1–400), offset, min_score.' },
  ...
  "results": [
	...
	},
	{
		...
		kind: 'route', method: 'GET', path: '/pois/providers/catalog', cost: 1,
  ...
  },
  {
	...
	},
	{
		...
		kind: 'route', method: 'GET', path: '/pois/providers/recommend', cost: 1,
  ...
  "providers": [
    { "id": "navitime", "label": "Navitime",               "score": 0.95,
      "byok": true,  "byok_header": "X-Navitime-Key", "for_events": false, "implemented": true },
    { "id": "overpass", "label": "OpenStreetMap / Overpass","score": 0.78,
      "byok": false, "for_events": false, "implemented": true },
	...
	},
	{
		...
		kind: 'route', method: 'GET', path: '/pois/providers', cost: 1,
		summary: "Liste les providers actuellement actifs (instances enregistrées au démarrage) avec leur flag BYOK. Pour le catalogue complet (providers non implémentés, scores par pays/catégorie, header BYOK), voir GET /pois/providers/catalog.",
		response: `[
  { "name": "overpass"         },
  { "name": "wikivoyage"       },
